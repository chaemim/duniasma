        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-header d-flex align-items-center">
              <h3 class="h4">Tambah Artikel</h3>
            </div>
            <div class="card-body">

              <form class="form-horizontal" action="{{asset('/admin/artikel')}}" method="post" enctype="multipart/form-data">
                   {{ csrf_field() }}
                ...
                <div class="form-group row">
                  ...
                  <input type="hidden" class="form-control" name="accepted"  value="1">
