        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-header d-flex align-items-center">
              <h3 class="h4">Tambah Video</h3>
            </div>
            <div class="card-body">

              <form class="form-horizontal" action="{{asset('/admin/video')}}" method="post">
                   {{ csrf_field() }}
                ...
                @else
                  <div class="form-group row">
                    <label class="col-sm-3 form-control-label">Deksripsi</label>
                    <div class="col-sm-9">
                      <textarea name="deskripsi" class="form-control" rows="8" cols="80">{{old('deskripsi')}}</textarea>
                    </div>
                  </div>
                @endif
                ...
                @else
                  <div class="form-group row">
                    <label class="col-sm-3 form-control-label">File Video</label>
                    <div class="col-sm-9">
                      <input type="text" placeholder="Key dari Youtube" class="form-control" name="file_video" value="{{old('file_video')}}">
                    </div>
                  </div>
                @endif
